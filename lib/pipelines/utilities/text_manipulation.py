...
from utilities import wiki_thresholds
import utilities
    ...
    for sentence in sentences:
        ...
        if len(sentence_words) > max_words_in_sentence:
            ...
            if len(splitted_sentences) > 1:
                print("Sentence with backslash was splitted. Doc Id: " + str(doc_id) +"   Sentence:  " + sentence)
            ...
            if "\n" in sentence:
                print("No split for sentence with backslash n. Doc Id: " + str(doc_id) +"   Sentence:  " + sentence)
